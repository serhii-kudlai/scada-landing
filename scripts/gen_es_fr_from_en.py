"""Generate src/i18n/{es,fr}.json from en.json (Google Translate). Requires: pip install deep-translator"""
...
def main() -> int:
    ...
    raw: object = json.loads(EN_PATH.read_text(encoding="utf-8"))

    for dest, code in (("es", "es"), ("fr", "fr")):
        cache: dict[str, str] = {}
